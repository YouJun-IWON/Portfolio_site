...
export const TistoryIcon = ({ className, ...rest }) => (
...
export const BrunchIcon = ({ className, ...rest }) => (
  <svg
    version='1.0'
    xmlns='http://www.w3.org/2000/svg'
    width='3em'
  ...
  >
    <g
      transform='translate(-30.000000,300.000000) scale(0.080000,-0.080000)'
      fill='#3e749e'
      stroke='none'
    >
      <path
...
722 32 384 0 698 -4 698 -8z'
      />
      <path
        d='M2517 3060 c-185 -200 -382 -469 -507 -695 l-33 -60 91 89 c109 107
119 124 105 171 -13 41 -12 43 78 113 123 96 246 246 294 357 27 65 35 85 31
85 -2 0 -29 -27 -59 -60z'
      />
      <path
        d='M2098 1932 c-170 -86 -381 -271 -544 -477 -92 -116 -159 -213 -153
