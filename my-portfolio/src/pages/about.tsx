          ...
          <div className='grid w-full grid-cols-8 gap-16 sm:gap-8'>
            <div className='col-span-3  flex flex-col items-start justify-start xl:col-span-4  md:order-2 md:col-span-8'>
              ...
              <p className='font-medium dark:text-gray-200 '>
                ...
                글(책)을 써왔습니다. 그 과정에서 삶의 의미는 곧 자신을 존재하게
                하는 시스템의 존재를 증명할 때 비로소 그 가치를 갖게 됨을 알 수
                있었습니다. 그 증명은 사회를 구성하는 구성원들의 연결을 더욱
                다양하게 하면서도 강화시키는 것입니다. 저는 스스로 이런 가치와
                목표를 납득했고 다음 두가지의 목표를 달성하려고 합니다.
              </p>
              ...
              <p className='my-4 font-medium  dark:text-gray-200 first-line:uppercase first-line:tracking-widest first-letter:text-7xl first-letter:font-bold first-letter:text-gray-900 dark:first-letter:text-gray-100 first-letter:mr-3 first-letter:float-left'>
                ...
                직관적이게 표시되는 것입니다. 동시에 보안적으로 문제가 없어야
                하는 것은 물론 서버와 클라이언트의 부담을 적절하게 분배하여 웹이
                최대한 온전히 작동될 수 있도록 하는 것입니다. 여기에 사용자에게
                긍정적인 인상을 남기는 디자인을 더해 추후 같은 목적을 떠올렸을
                때 이 웹이 떠오르게 하는 것입니다.
              </p>
